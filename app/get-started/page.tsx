      ...
      <div className='relative bg-white pt-[120px] dark:bg-dark lg:pt-[150px]'>
        <div className='container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl md:text-center'>
            ...
            <p className='mt-4 tracking-tight text-slate-600'>Fill in the form below to join the community of businesses benefiting from Amcy OOH Digital Out of Home Advertising Solutions.</p>
          </div>
