...
import { services, locations } from "./ui/data";
    ...
    <>
      ...
      <div className='relative flex flex-auto overflow-hidden bg-white pt-14 !rounded-t-[40px] transform-none' style={{ transformOrigin: "50% 50% 0px" }}>
        <div className='relative isolate flex w-full flex-col pt-9' style={{ transform: "none", transformOrigin: "50% 50% 0px" }}>
          ...
          >
            <rect width='100%' height='100%' fill='url(#bgk)' stroke-width='0'></rect>
          ...
          <main className='w-full flex-auto'>
            <div className='mx-auto max-w-7xl px-6 lg:px-8 mt-24 sm:mt-32 md:mt-48'>
              <div className='mx-auto max-w-2xl lg:max-w-none'>
                <div className='max-w-3xl'>
                  <h1 className='font-display text-3xl font-medium tracking-tight text-[#E10000] [text-wrap:balance] sm:text-6xl'>Innovative Brand Awareness and Engagement Solutions</h1>
