          ...
          <div className='flex flex-wrap items-center justify-between -mx-4'>
            ...
            <div className='w-full px-4 lg:w-1/2 xl:w-5/12'>
              <div className='mt-10 lg:mt-0'>
                ...
                <h2 className='mb-5 text-3xl font-bold text-slate-900 dark:text-white sm:text-[40px]/[48px]'>Streamline Your out-of-home advertising with AMCY OOH</h2>
                <p className='mb-5 text-base text-body-color dark:text-slate-200'>
                  AMCY OOH is an innovative Digital out-of-home advertising service based in Nairobi, Kenya. AMCY OOH connects business brands with their target audience where they live, shop, dine,
                  and work.
                </p>
                <p className='mb-8 text-base text-body-color dark:text-slate-200'>
                  With a mission to deliver value to Startups, SMEs and Business Brands, AMCY OOH leverages data, innovation and technology to drive unique brand awareness and engagement campaigns.
                  AMCY OOH provides affordable, reliable and timely solutions to brands ensuring that your brand is placed on the right platform, at the right time, and with the right content.{" "}
                </p>
                <a
