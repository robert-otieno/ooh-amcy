            ...
            <div className='w-full px-4 sm:w-2/3 lg:w-3/12'>
              <div className='mb-10 w-full'>
                ...
                <p className='mb-7 text-base text-body-color dark:text-dark-6'>
                  AMCY OOH is Committed to Delivering Exceptional Customer Experiences for startups, SMEs and Business Brands in Kenya. Whether you’re just starting out, launching a new
                  product/service, or looking to increase, build and scale your brand, you can trust AMCY OOH, every day.
                </p>
